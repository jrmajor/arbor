        ...
        <div class="px-3 flex items-center justify-between flex-wrap">
            ...
            <div class="flex items-center">
                <a href="{{ route('people.index') }}"
                    class="px-2 py-1 text-gray-800 rounded hover:text-gray-900 hover:no-underline hover:bg-gray-100 transition-colors duration-200 ease-out flex items-center">
            ...
            <button
                @click="open = ! open"
                type="button"
                class="block lg:hidden p-2 -my-2 text-gray-800 hover:text-gray-900 focus:outline-none">
